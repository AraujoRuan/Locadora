    ...
    public class Address : ValueObject
    {
            ...
            string zipCode)
        {
            if (string.IsNullOrEmpty(street))
                throw new DomainExceptionValidation("Só pode Conter nome de Rua");
            Street = street;
            if (string.IsNullOrEmpty(number))
                throw new DomainExceptionValidation("Só pode conter numeros");
            Number = number;
            ...
            if (string.IsNullOrEmpty(district))
                throw new DomainExceptionValidation("Só pode conter Distrito");
            District = district;
            if (string.IsNullOrEmpty(city))
                throw new DomainExceptionValidation("Só pode conter Cidade");
            City = city;
            if (string.IsNullOrEmpty(state))
                throw new DomainExceptionValidation("Só pode conter Estado");
            State = state;
            if (string.IsNullOrEmpty(zipCode))
                throw new DomainExceptionValidation("Só pode Conter CEP");
            ZipCode = zipCode;
        }
